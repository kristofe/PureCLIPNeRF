...
fine_train.update(dict(
    N_iters=1500,                # number of optimization steps
    pg_scale=\
        [500, 700, 900, 1100],# checkpoints for progressive scaling

    tv_every=1,                   # count total variation loss every tv_every step
    tv_after=500,                # count total variation loss from tv_from step
    tv_before=1300,              # count total variation before the given number of iterations
    ...
    prior_before = 800,          # Iteration to stop adding kl loss
